...
\newenvironment{revisado}
  {\begin{tcolorbox}[colback=celeste!50, boxrule=0pt, sharp corners, breakable, before upper={\setlength{\parindent}{15pt}}]}
  {\end{tcolorbox}}
  \newenvironment{corregir}
  {\begin{tcolorbox}[colback=yellow!50, boxrule=0pt, sharp corners, breakable, before upper={\setlength{\parindent}{15pt}}]}
  {\end{tcolorbox}}
%
%
%
