...
\colorlet{entitylocation}{MaterialBlue700}
\colorlet{entityidentifier}{MaterialCyan700}
\colorlet{entityprovider}{MaterialDeepPurple600}
\colorlet{entitypersoncolor}{MaterialRed700}
\colorlet{entitydatecolor}{MaterialOrange800}
\colorlet{entitytimecolor}{MaterialGreen700}
\tcbset{
    revisionbox/.style={
        boxrule=0pt,
        sharp corners,
...
\newcommand{\entityairportcode}[1]{\entitytag{entitylocation}{AIRPORT\_CODE}{#1}}
\newcommand{\entitytrainstation}[1]{\entitytag{entitylocation}{TRAIN\_STATION}{#1}}
\newcommand{\entitypnrcode}[1]{\entitytag{entityidentifier}{FLIGHT\_NUMBER}{#1}}
\newcommand{\entitytrainnumber}[1]{\entitytag{entityidentifier}{TRAIN\_NUMBER}{#1}}
\newcommand{\entitytrainticketcode}[1]{\entitytag{entityprovider}{TRAIN\_TICKET\_CODE}{#1}}
\newcommand{\entityairlinename}[1]{\entitytag{entityprovider}{AIRLINE\_NAME}{#1}}
\newcommand{\entityperson}[1]{\entitytag{entitypersoncolor}{PERSON}{#1}}
\newcommand{\entitydate}[1]{\entitytag{entitydatecolor}{DATE}{#1}}
\newcommand{\entitytime}[1]{\entitytag{entitytimecolor}{TIME}{#1}}
